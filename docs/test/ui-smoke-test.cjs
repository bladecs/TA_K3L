...
const scenarios = [
  {
    ...
    tests: [
      ...
      { name: 'public-dashboard-gis', path: '/user/dashboard#peta-gis-hazard', contains: ['Daftar Titik Rawan', 'Denah Kampus'] },
      { name: 'public-incident-form', path: '/user/incidents/create', contains: ['Form Pelaporan K3L', 'Form Insiden', 'Identitas pelapor'] },
  ...
  },
  {
    ...
    tests: [
      ...
      { name: 'admin-campus-rooms', path: '/admin/campus-rooms', contains: ['Ruangan per Gedung'] },
      { name: 'admin-floorplans', path: '/admin/floorplans', contains: ['Denah per Gedung dan Lantai'] },
      { name: 'admin-floorplan-create', path: '/admin/floorplans/create', contains: ['Koordinat Ruangan', 'Generate Denah'] },
